...
> 하나씩 인터프리팅하여 실행하는 것이 아니라, 바이트 코드 전체가 컴파일된 네이티브 코드를 실행하는 것이기 때문에  
> 전체적인 실행 속도는 인터프리팅 방식보다 빠르다

> 네이티브 코드는 캐시에 보관되기 때문에 한 번 컴파일 된 코드는 캐시에서 바로 꺼내어 실행하기 때문에 빠르게 수행된다.
> 
...
https://github.com/wjdrbs96/Today-I-Learn/blob/master/Java/JVM/JVM.md
